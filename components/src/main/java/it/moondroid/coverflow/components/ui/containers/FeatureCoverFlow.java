...
public class FeatureCoverFlow extends EndlessLoopAdapterContainer implements ViewTreeObserver.OnPreDrawListener {
	...
	class CoverFrame extends FrameLayout{
	...
	/**
	 * Removes links to all pictures which are hold by com.lihb.coverflow to speed up rendering
